...
class UserAgent:
    ...
    def cycleUA():
        """
        Returns a random user-agent from a list of 1000 user-agents.
        """

        UAS = ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/37.0.2062.94 Chrome/37.0.2062.94 Safari/537.36",
